...
#### CUE sheet files
When capturing a Broadcast Wave file prior to transcoding to .flac, a corresponding CUE file must be generated. The CUE file must:
...
#### Reproduction details  
  ...
  * A full complement of stylus shapes and sizes should be on-hand at the vendor transfer station, and **the best sounding size/shape stylus used for transfer should be noted in the metadata digitization process notes.**
